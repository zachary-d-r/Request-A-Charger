...
# Test values and pulses
angular_servo.to_mid()
print(angular_servo.calibration().value_to_pulse(angular_servo.value()))
sleep(5)

angular_servo.to_max()
print(angular_servo.calibration().value_to_pulse(angular_servo.value()))
sleep(5)

angular_servo.to_min()
print(angular_servo.calibration().value_to_pulse(angular_servo.value()))
sleep(5)

angular_servo.disable()
# # ---------------------------------------------------
